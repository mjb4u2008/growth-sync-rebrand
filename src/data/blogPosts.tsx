...
export const blogPosts = [
  {
    ...
    content: (
      <>
        ...
        <p className="text-lg leading-relaxed mb-8">
          The actual growth rate looks bigger than the headlines. During Tech Week, at a commerce event, TikTok's Head of Collectibles said Labubu is doing almost $800 million a year through TikTok, with individual shops moving millions of units a month. That is a different scale of behavior than most people are pricing into social commerce.
        </p>
        <p className="text-lg leading-relaxed mb-8">
          I believe those numbers because we have seen the behavior up close. Rod and I were there when Canvas Beauty crossed the first million-dollar TikTok Live in the US. When a brand can turn a live social moment into a seven-figure storefront, the category is no longer theoretical.
        </p>
        <p className="text-lg leading-relaxed mb-8">
          China makes the gap even more obvious. <ContentLink href="https://www.businesswire.com/news/home/20250509699622/en/China-Social-Commerce-Market-Intelligence-Report-2025-Douyin-and-Xiaohongshu-Leading-the-Integration-of-Social-Interaction-and-Online-Shopping---Future-Growth-Dynamics-to-2030---ResearchAndMarkets.com">ResearchAndMarkets estimated China's social commerce market at $537 billion in 2025</ContentLink>, and other reports put Chinese live commerce in the multi-trillion-yuan range. At the same Tech Week commerce event, TikTok leads described social commerce around TikTok in China as a $12 trillion market this year. There is a clear gap between what operators are saying and what public headlines are saying. I tend to trust the people building inside the platforms.
        </p>
        <p className="text-lg leading-relaxed mb-8">
