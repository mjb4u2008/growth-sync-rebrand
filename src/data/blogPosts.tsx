...
export const blogPosts = [
  {
    ...
    content: (
      <>
        ...
        <p className="text-lg leading-relaxed mb-8">
          The public numbers are the floor. <ContentLink href="https://thelowdown.momentum.asia/new-report-tiktok-shop-u-s-gmv-grew-68-to-reach-us15-1b-in-2025/">Momentum Works and Tabcut estimate</ContentLink> that TikTok Shop reached $15.1 billion in US GMV in 2025, up 68% year over year. <ContentLink href="https://www.retaildive.com/news/tiktok-shop-drives-social-commerce-growth/807665/">Retail Dive, citing EMARKETER</ContentLink>, reported that US social commerce is expected to pass $100 billion in 2026.
        </p>
        <p className="text-lg leading-relaxed mb-8">
        ...
        <p className="text-lg leading-relaxed mb-8">
          I believe those numbers because we have seen the behavior up close. Rod and I were there when Canvas Beauty crossed the first $1 million on TikTok Live in the US. When social-native brands can turn live moments into seven-figure events and nine-figure storefronts, the category is no longer theoretical.
        </p>
        <p className="text-lg leading-relaxed mb-8">
          China makes the gap even more obvious. <ContentLink href="https://www.businesswire.com/news/home/20250509699622/en/China-Social-Commerce-Market-Intelligence-Report-2025-Douyin-and-Xiaohongshu-Leading-the-Integration-of-Social-Interaction-and-Online-Shopping---Future-Growth-Dynamics-to-2030---ResearchAndMarkets.com">ResearchAndMarkets estimated China's social commerce market at $537 billion in 2025</ContentLink>, but TikTok leadership claims China has become a $12 trillion social commerce market just from live shopping. There is a clear gap between what operators are saying and what public headlines are saying. I tend to trust the people building inside the platforms.
        </p>
        <p className="text-lg leading-relaxed mb-8">
